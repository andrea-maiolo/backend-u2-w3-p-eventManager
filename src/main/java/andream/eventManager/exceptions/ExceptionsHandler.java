...
import andream.eventManager.payloads.ErrorDTO;
import andream.eventManager.payloads.ErrorsListDTO;
...
public class ExceptionsHandler {
    ...
    public ErrorsListDTO handleValidationErrors(ValidationException ex) {
        return new ErrorsListDTO(ex.getMessage(), LocalDateTime.now(), ex.getMessagesLog());
    }
